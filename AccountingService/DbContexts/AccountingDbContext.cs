    ...
    public class AccountingDbContext : DbContext
    {
       ...
       protected override void  OnModelCreating(ModelBuilder modelBuilder)
       {
           ...
           modelBuilder.Entity<AccountType>().HasData(
               new AccountType{Id = 1, Name = "Cash and Bank", GroupId=1}, 
               new AccountType{Id = 2, Name = "Money in Transit", GroupId=1},
               new AccountType{Id = 3, Name = "Expected Payments from Customers", GroupId=1});


            modelBuilder.Entity<Account>().HasData(
                new Account{Id = 1, Name = "Cash On Hand", GroupId=1, AccountTypeId = 1 } 
            );
       }
